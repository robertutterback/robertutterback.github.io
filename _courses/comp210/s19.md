...
| Fri 01/25         | Class Relationships                              | Read [this][4]                                                                                   |
| Mon 01/28         | Containtment vs. Extension                       |                                                                                                  |
| Wed 01/30         | (Class Cancelled)                                |                                                                                                  |
| Wed 01/30-Lab     |                                                  | Lab 3, [Exam 1](exam1.pdf) out                                                                   |
| Fri 02/01         | Lists, ADTs and PDAs                             |                                                                                                  |
| Mon 02/04         | (Class Cancelled)                                |                                                                                                  |
