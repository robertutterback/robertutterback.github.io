...
| Mon 03/12         | JavaFX Basics, Property Binding                      | Read [this][9]                                      |
| Wed 03/14         | Event-Driven Programming                             | Project 1 Free Lab                                  |
| Fri 03/16         | Lambda Functions                                     |                                                     |
| Mon 03/19         | (Project 1 questions)                                |                                                     |
| Wed 03/21         | Tic Tac Toe Design                                   | Project 1 due, [Lab 7](lab7.pdf)                    |
| Fri 03/23         | Tic Tac Toe with MVC                                 |                                                     |
| Mon 03/26         | (Exam 3)                                             | Exam 3                                              |
| Wed 03/28         |                                                      | [Lab 8](lab8.pdf)                                   |
| (03/30--04/02)    | (Easter Break)                                       | (Easter Break)                                      |
| Wed 04/04         | Testing Controllers with Mock Objects                | [Lab 9](lab9.pdf)                                   |
| Fri 04/06         | Design Principles and Software Patterns              |                                                     |
| Mon 04/09         | Builder                                              |                                                     |
| Wed 04/11         | Factory                                              | [Lab 10](lab10.pdf)                                 |
| Fri 04/13         | Visitor                                              | Exam 4                                              |
| Mon 04/16         | Iterator                                             |                                                     |
| Wed 04/18         | Singleton                                            | [Project 2](proj2.pdf)                              |
| Fri 04/20         | Wrapper/Adapter                                      |                                                     |
| Mon 04/23         |                                                      |                                                     |
| Wed 04/25         | Composite                                            | Exam 5 due (part of project 2)                      |
| Fri 04/27         |                                                      |                                                     |
...
<!--   Testing (unit tests vs. integration, mocks, continuous integration) -->
<!--   Javascript (or OO in other languages) -->
...
[9]: https://docs.oracle.com/javase/8/javafx/get-started-tutorial/jfx-architecture.htm
