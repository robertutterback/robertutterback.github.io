...
Java Programming language. As is true with all programming paradigms,
OOP constitutes not just a set of tools for writing programs but a way
of thinking and reasoning about the structure of programs and
...
* Developing GUI-Based Programs using Model-View-Controller (MVC) • Basic OO Design Patterns
...
* Oracle. *Java 8
  API* 2014. [https://docs.oracle.com/javase/8/docs/api/](https://docs.oracle.com/javase/8/docs/api/)
...
Notes:
- Get through at least lecture 2 in the notes before lab 1, maybe even lecture 3!
- Other topics: Git and version control, design patterns, testing, software architecture and design

{: .schedule}
| date              | topic                                             | Assignment              |
| :-------:         | :-----:                                           |                         |
| Mon 01/15         | Programming Environment: Java, JUnit, and Eclipse |                         |
| Wed 01/17         | Procedural Java                                   | [Lab 1](lab1.pdf)       |
| Fri 01/19         | Intro to Object-Oriented Programming              |                         |
| Mon 01/22         | Basic Classes and Hierarchies                     |                         |
| Wed 01/24         | Implementing Hierarchies, UML                     | [Lab 2](lab2.pdf)       |
| Fri 01/26         | Polymorphic Method Dispatch                       |                         |
| Mon 01/29         | Extending Classes                                 |                         |
| Wed 01/31         |                                                   | [Lab 3](lab3.pdf)       |
| Fri 02/02         | Containment vs. Extension                         |                         |
| Mon 02/05         | Data Structures Redux: Lists                      |                         |
| Wed 02/07         | Trees                                             | [Lab 4](lab4.pdf)       |
| Fri 02/09         |                                                   |                         |
| Mon 02/12         | Heaps                                             |                         |
| Wed 02/14         |                                                   | [Lab 5](lab5.pdf)       |
| Fri 02/16         | Generics                                          | [Exam 1](exam1.pdf) out |
| Mon 02/19         |                                                   |                         |
| Wed 02/21         | Huffman Codes                                     | [Lab 6](lab6.pdf)       |
| Fri 02/23         |                                                   |                         |
| Mon 02/26         |                                                   |                         |
| Wed 02/28         |                                                   | Project 1 Lab           |
| Fri 03/02         |                                                   | Exam 2                  |
...
| Wed 04/04         |                                                   | [Lab 9](lab9.pdf)       |
| Fri 04/06         |                                                   | Exam 4                  |
| Mon 04/09         |                                                   |                         |
| Wed 04/11         |                                                   | [Lab 10](lab10.pdf)     |
| Fri 04/13         |                                                   |                         |
| Mon 04/16         |                                                   |                         |
| Wed 04/18         |                                                   | Project 2 Lab           |
| Fri 04/20         |                                                   | Exam 5                  |
| Mon 04/23         |                                                   |                         |
| Wed 04/25         |                                                   | Project 2               |
| Fri 04/27         |                                                   |                         |
