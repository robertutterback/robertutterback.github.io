...
| Wed 10/17           | Mean, Median, Mode                                                | Read APM Ch. 16                                                       |
| Fri 10/19           | Model Evaluation                                                  |                                                                       |
| Mon 10/22 (Week 10) | Imbalanced Data                                                   | HW 4 out                                                              |
| Tue 10/23           | Dimensionality Reduction                                          |                                                                       |
| (Wed 10/24)         | (Mentoring Day -- No class)                                       |                                                                       |
| Fri 10/26           | Clustering                                                        |                                                                       |
| Mon 10/29 (Week 11) | Clustering Evaluation                                             |                                                                       |
| Tue 10/30           | NMF and Outlier Detection                                         |                                                                       |
| Wed 10/31           |                                                                   |                                                                       |
