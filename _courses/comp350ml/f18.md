...
| Tue 10/16 (Week 9)  | Mean, Median, Mode                                                | Read APM Ch. 16, HW 3 due [(Solutions)][7]                            |
| Wed 10/17           | Model Evaluation                                                  |                                                                       |
| Fri 10/19           | Imbalanced Data                                                   |                                                                       |
| Mon 10/22 (Week 10) | Dimensionality Reduction                                          | HW 4 out                                                              |
| Tue 10/23           | Clustering                                                        |                                                                       |
| (Wed 10/24)         | (Mentoring Day -- No class)                                       |                                                                       |
| Fri 10/26           | Clustering Evaluation                                             |                                                                       |
