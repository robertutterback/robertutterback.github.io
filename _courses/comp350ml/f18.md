...
| Tue 11/06           | [Clustering Evaluation](./L38.html)                               | Read IMLP 193-211                                                       |
| Wed 11/07           | NMF and Outlier Detection                                         | Read IMLP 158-170                                                       |
| Fri 11/09           | Working with text data                                            |                                                                         |
| Mon 11/12 (Week 13) | Topic models for text data                                        |                                                                         |
| Tue 11/13           | Word and document embeddings                                      |                                                                         |
| Wed 11/14           |                                                                   |                                                                         |
| Fri 11/16           |                                                                   | HWK 4 due                                                               |
