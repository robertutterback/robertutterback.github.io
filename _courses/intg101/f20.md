...
In addition, you will need access to a computer or mobile device with
a camera and microphone for accessing Zoom class discussions and
viewing online materials. A laptop/desktop computer is **highly**
recommended over a mobile device.
...
| Wed 08/19 | "Only Connect"                          |                                  |
| Thu 08/20 |                                         |                                  |
| Fri 08/21 | "How to Get the Most Out of College"    |                                  |
|-----------+-----------------------------------------+----------------------------------|
| Mon 08/24 | Allegory of the Cave                    |                                  |
| Wed 08/26 | How to Read a Book: The Ultimate Guide  |                                  |
| Thu 08/27 |                                         |                                  |
| Fri 08/28 |                                         | Bedford Handbook ch. 3, HH intro |
|-----------+-----------------------------------------+----------------------------------|
| Mon 08/31 |                                         | HH ch. 1, 1-1 appointment        |
| Wed 09/02 |                                         | HH ch. 2                         |
| Thu 09/03 |                                         |                                  |
| Fri 09/04 |                                         | HH ch. 7                         |
|-----------+-----------------------------------------+----------------------------------|
...
* **Writing Tutoring**: The Writing Center offers unlimited, free peer
  ...
  to drafting to revising to editing. The Writing Center is located on
  the 3rd floor of the Mellinger Teaching and Learning Center. No
  appointments are necessary for in-person tutoring. Email [Dr. Shweta
  Arpit Srivastava](mailto:ssrivastava@monmouthcolege.edu) for online
