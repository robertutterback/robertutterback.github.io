...
| :-------:         | :-----:                                                          |                                                           |
| Wed 08/22         | Intro, Using [VNC](./vnc.pdf) and [CodeBlocks](./codeblocks.pdf) | Review 161 Shell Notes [1][1] and [2][2]                  |
...
| Wed 10/10         | [Exceptions](29-exceptions.pdf)                                  |                                                           |
| (10/11--10/15)    | (Fall Break)                                                     | (Fall Break)                                              |
| Wed 10/17         | Memory and Pointers                                              | Read 11.1-11.2                                            |
| Thu 10/18         | Reverse Polish Notation Calculator                               | Exam 4 due, [Project 1](./proj1.pdf) out                  |
...
| Thu 11/01         | Linked List Stack (Lab)                                          | [Lab 8](lab8.pdf)                                         |
| Fri 11/02         | DoubleStack                                                      |                                                           |
| Mon 11/05         | (Class Cancelled)                                                | [Exam 5](exam5.pdf) (take-home)                           |
| Wed 11/07         | Object Copying                                                   | Read 12.7                                                 |
| Thu 11/08         | Implementing IntVector                                           | [Lab 9](lab9.pdf)                                         |
| Fri 11/09         | Dynamic Array Analysis                                           | Read 12.8                                                 |
| Mon 11/12         | Templates                                                        | Read 14.1-14.2                                            |
| Wed 11/14         | Implementing Queues                                              | Read 14.3                                                 |
| Thu 11/15         | Big Integers                                                     | [Project 2](proj2.pdf) out                                |
| Fri 11/16         | Implementing Vectors                                             | Labp2 due, Read 14.4-14.5                                 |
| Mon 11/19         | Exam 6                                                           |                                                           |
| (11/21--11/25)    | (Thanksgiving Break)                                             | (Thanksgiving Break)                                      |
| Mon 11/26         | Maps with Vectors                                                | Read 15.1                                                 |
| Wed 11/28         | Hashing                                                          | Read 15.2-16.4                                            |
| Thu 11/29         | Free lab for Project 2                                           |                                                           |
| Fri 11/30         | Binary Search Trees                                              | Project 2 Due, Read 16.1-16.2                             |
