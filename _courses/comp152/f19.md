...
|-----------------------+------------------------------------------------------------+-----------------------------------------------------------------|
| Mon 10/07             | Singly Linked Lists                                        | 7.1                                                             |
...
|-----------------------+------------------------------------------------------------+-----------------------------------------------------------------|
| Mon 10/14             | Linked Lists                                               | 7.2-7.3, 7.7                                                    |
| Wed 10/16             | Recursion                                                  | 4.1, 4.3                                                        |
| Wed 10/16 -- Lab      |                                                            | Project 1 Due                                                   |
| Fri 10/18             | Recurrences I                                              | 4.2                                                             |
|-----------------------+------------------------------------------------------------+-----------------------------------------------------------------|
| Mon 10/21             | Recurrences II                                             |                                                                 |
| (Wed 10/23)           | (No class -- Mentoring Day)                                |                                                                 |
| (Wed 10/23 -- Lab)    | (No class -- Mentoring Day)                                |                                                                 |
| Fri 10/25             | Recursion                                                  | 4.4-4.6                                                         |
|-----------------------+------------------------------------------------------------+-----------------------------------------------------------------|
| Mon 10/28             | Selection Sort and Insertion Sort                          | 12.1                                                            |
| Wed 10/30             | Merge Sort and Quick Sort                                  | 12.2-12.3                                                       |
| Wed 10/30 -- Lab      |                                                            |                                                                 |
