...
| Wed 09/04             | Inheritance and Polymorphism in Python                     |                                                                 |
...
| Wed 09/11             | Common Growth Functions                                    | 3.2                                                             |
| Wed 09/11 -- Lab      | Lab 3: TBD                                                 |                                                                 |
| Fri 09/13             | Asymptotic Analysis I                                      | 3.3, [Asymptotic Notation][5] (all sections)                    |
|-----------------------+------------------------------------------------------------+-----------------------------------------------------------------|
| Mon 09/16             | Asymptotic Analysis II                                     | 3.4                                                             |
| Wed 09/18             | Array-Based Sequences                                      | 5.1-5.3                                                         |
| Wed 09/18 -- Lab      | Lab 4: TBD                                                 |                                                                 |
| Fri 09/20             | Dynamic Array Analysis                                     | 5.4                                                             |
|-----------------------+------------------------------------------------------------+-----------------------------------------------------------------|
| Mon 09/23             | Exam Review                                                |                                                                 |
| Wed 09/25             | Exam I                                                     |                                                                 |
| Wed 09/25 -- Lab      |                                                            | Project 1 out                                                   |
| Fri 09/27             | Applications of Sequences                                  | 5.5                                                             |
|-----------------------+------------------------------------------------------------+-----------------------------------------------------------------|
| Mon 09/30             | Stacks, Queues, and Deques                                 | 6.1-6.3                                                         |
