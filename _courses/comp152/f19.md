...
* Feedback: At any time during the course you can use provide
  anonymous feedback (suggestions, criticism, praise, etc.) via the
  below form: {{site.data.semesters[page.semester].feedback_form}}
