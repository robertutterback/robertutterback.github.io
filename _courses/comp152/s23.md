...
| **Wed 03/15 (lab)**      | Lab 5: Recursion Practice                   |                         |
| Fri 03/17                | Exam 3 (Mostly Ch. 4, some 5,6)             |                         |
|--------------------------+---------------------------------------------+-------------------------|
| Mon 03/20 (Week 10)      | Sorting: Insertion and Selection Sort       |               12.1, 5.5 |
| Wed 03/22                | Mergesort                                   |                    12.2 |
| **Wed 03/22 (lab)**      | Lab 7: Sorting                              |                         |
| Fri 03/24                | Quicksort                                   |                    12.3 |
|--------------------------+---------------------------------------------+-------------------------|
| Mon 03/27 (Week 11)      | Singly-Linked lists                         |                       7 |
| Wed 03/29                | Doubly-Linked Lists                         |                 7.2-7.3 |
| **Wed 03/29 (lab)**      | Lab 8: Linked Lists                         |                         |
| Fri 03/31                |                                             |                         |
|--------------------------+---------------------------------------------+-------------------------|
