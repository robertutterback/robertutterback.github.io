...
| **Wed 01/18 (lab)**      | Lab 2: Vector class                      |                         |
...
|--------------------------+------------------------------------------+-------------------------|
| Mon 03/13 (Week 9)       | Sorting, Insertion Sort                  |               12.1, 5.5 |
| Wed 03/15                | Mergesort                                |                    12.2 |
| **Wed 03/15 (lab)**      | Lab 8                                    |                         |
| Fri 03/17                | Exam 3 (Mostly Ch. 4, some 5,6)          |                         |
|--------------------------+------------------------------------------+-------------------------|
| Mon 03/20 (Week 10)      | Quicksort                                |                    12.3 |
| Wed 03/22                |                                          |                         |
| **Wed 03/22 (lab)**      | Lab 9                                    |                         |
| Fri 03/24                |                                          |                         |
|--------------------------+------------------------------------------+-------------------------|
| Mon 03/27 (Week 11)      | Singly-Linked lists                      |                       7 |
| Wed 03/29                | Doubly-Linked Lists                      |                 7.2-7.3 |
| **Wed 03/29 (lab)**      | Lab 10                                   |                         |
| Fri 03/31                |                                          |                         |
|--------------------------+------------------------------------------+-------------------------|
| Mon 04/03 (Week 12)      | Binary Trees                             |                 8.1-8.2 |
| Wed 04/05                | Exam 4 (Ch. 12,7)                        |                         |
...
|--------------------------+------------------------------------------+-------------------------|
| Mon 04/24 (Week 15)      | Exam 5 (Ch. 8,9)                         |                         |
...
| **Wed 05/03 (lab)**      |                                          |                         |
| ======                   | =======                                  |                  ====== |
| **Fri 05/05, 8:00 AM**   | Exam 6 (Final)                           |                         |
