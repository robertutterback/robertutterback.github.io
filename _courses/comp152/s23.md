...
| Wed 04/05                | Exam 5 (Ch. 6,7)                         |                         |
| **Wed 04/05 (lab)**      | Lab 11                                   |                         |
| (Fri 04/07)              | (Easter Break)                           |                         |
|--------------------------+------------------------------------------+-------------------------|
| (Mon 04/10) (Week 13)    | (Easter Break)                           |                         |
| Wed 04/12                | Binary Tree Implementation               |                     8.3 |
| **Wed 04/12 (lab)**      | Lab 12                                   |                         |
| Fri 04/14                | Tree Traversals                          |                     8.4 |
|--------------------------+------------------------------------------+-------------------------|
| Mon 04/17 (Week 14)      | Priority Queues                          |                 9.1-9.2 |
| Wed 04/19                | Heaps                                    |                     9.3 |
| **Wed 04/19 (lab)**      | Lab 13: Project 2 Lab                    |                         |
| Fri 04/21                | Heapsort                                 |                     9.4 |
|--------------------------+------------------------------------------+-------------------------|
| Mon 04/24 (Week 15)      | Exam 6 (Ch. 8,9)                         |                         |
| Wed 04/26                | Maps, Hashing                            |               10.1-10.2 |
| **Wed 04/26 (lab)**      | (Project 2 Open Lab)                     |                         |
...
| **Wed 05/03 (lab)**      |                                          |                         |
| ======                   | =======                                  |                  ====== |
| **Fri 05/05, 8:00 AM**   | Exam 7 (Final)                           |                         |
