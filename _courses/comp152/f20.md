...
| Fri 10/09           | Stacks                               |                            6.1 |
|---------------------+--------------------------------------+--------------------------------|
| Mon 10/12 (Week 9)  | Queues                               |                            6.2 |
| Wed 10/14           |                                      |                                |
...
| Fri 10/30           | Exam 3                               |                                |
|---------------------+--------------------------------------+--------------------------------|
| Mon 11/02 (Week 12) | Tree Traversal                       |                            8.4 |
| Wed 11/04           | Priority Queues                      |                        9.1-9.2 |
| Wed 11/04 (lab)     | Lab 11: TBD                          |                                |
| Fri 11/06           | Heaps                                |                            9.3 |
|---------------------+--------------------------------------+--------------------------------|
| Mon 11/09 (Week 13) | Hash Tables                          |                      10.1-10.2 |
| Wed 11/11           | Sorted Maps and Sets                 |                     10.3, 10.5 |
| Wed 11/11 (lab)     | Project 2                            |                                |
| Fri 11/13           | Binary Search Trees                  |                      11.1-11.2 |
|---------------------+--------------------------------------+--------------------------------|
| Mon 11/16 (Week 14) | Insertion/Selection/Heap Sort        |                5.5.2, 7.5, 9.4 |
