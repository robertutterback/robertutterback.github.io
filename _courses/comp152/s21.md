...
* Class meetings:
  * Class: MWF 8:00 am - 9:50 AM
  * Lab: W 2:00 pm - 3:50 PM
  * Zoom Room: TBD. <!-- @TODO: COMP152 Zoom room -->
...
|---------------------+--------------------------------------+-------------------------------|
| Mon 01/25 (Week 1)  | Logistics, Overview                  |                       1.1-1.3 |
| Wed 01/27           | Python Review                        |                       1.4-1.5 |
| Wed 01/27 (lab)     | Lab 1: Python Basics with Turtle     |                               |
| Fri 01/29           | Advanced Python Features             |                       1.6-1.9 |
|---------------------+--------------------------------------+-------------------------------|
| Mon 02/01 (Week 2)  | Review Exercises                     |                     1.10-1.11 |
| Wed 02/03           |                                      |                               |
| Wed 02/03 (lab)     | Lab 2: Sets and Dictionaries         |                               |
| Fri 02/05           | Classes                              |                       2.1-2.3 |
|---------------------+--------------------------------------+-------------------------------|
| Mon 02/08 (Week 3)  | Inheritance                          |                           2.4 |
| Wed 02/10           | Containment vs. Extension; Misc. OOP |                       2.5-2.6 |
| Wed 02/10 (lab)     | Lab 3: Object-Oriented Turtle        |                               |
| Fri 02/12           | Experimental Performance Analysis    |                           3.1 |
|---------------------+--------------------------------------+-------------------------------|
| Mon 02/15 (Week 4)  | Big-O                                |                           3.2 |
| Wed 02/17           | Analysis Exercises                   |                           3.3 |
| Wed 02/17 (lab)     | Lab 4: Prefix Sums                   |                               |
| Fri 02/19           | Exam 1 (Ch. 1-2)                     |                               |
|---------------------+--------------------------------------+-------------------------------|
| Mon 02/22 (Week 5)  | Justification and Proof              |                           3.4 |
| Wed 02/24           | Big-O and Proof Examples             |                               |
| Wed 02/24 (lab)     | Hwk 5: Big-O Practice                |                               |
| Fri 02/26           | Common Python Bugs                   |  [Handout 1][1], [Handout][2] |
|---------------------+--------------------------------------+-------------------------------|
| Mon 03/01 (Week 6)  | Recursive Functions                  |                           4.1 |
| Wed 03/03           | Recurrences                          |                       4.2-4.3 |
