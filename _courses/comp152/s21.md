...
| Wed 04/14           | (Break!)                                     |                                         |
| Wed 04/14 (lab)     | Lab: TBD?                                    |                                         |
| Fri 04/16           | Binary Trees                                 |                                 8.1-8.3 |
|---------------------+----------------------------------------------+-----------------------------------------|
| Mon 04/19 (Week 13) | Tree Traversals                              |                                     8.4 |
| Wed 04/21           | Priority Queues                              |                                 9.1-9.3 |
| Wed 04/21 (lab)     | Lab 8: Heaps                                 |                                         |
| Fri 04/23           | Heapify, Sorting                             |                                     9.4 |
|---------------------+----------------------------------------------+-----------------------------------------|
| Mon 04/26 (Week 14) | Maps: Naive Implementations                  |                              10.1, 10.3 |
| Wed 04/28           | Hash Tables and related                      |                              10.2, 10.5 |
