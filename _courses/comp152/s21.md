...
|---------------------+----------------------------------------------+-----------------------------------------|
| Mon 03/15 (Week 8)  | Arrays                                       |                                     5.1 |
| Wed 03/17           | Dynamic Array Analysis                       |                                 5.2-5.3 |
...
| Fri 04/02           | Circularly-Linked Lists                      |                                     7.2 |
|---------------------+----------------------------------------------+-----------------------------------------|
| Mon 04/05 (Week 11) | Doubly-Linked Lists                          |                                     7.3 |
| Wed 04/07           |                                              |                                         |
| Wed 04/07 (lab)     | (Free Lab for Project 1)                     |                                         |
| Fri 04/09           | Exam 3 (Ch. 4-7)                             |                                         |
|---------------------+----------------------------------------------+-----------------------------------------|
| Mon 04/12 (Week 12) | Binary Trees                                 |                                 8.1-8.2 |
| Wed 04/14           | Binary Tree Implementation                   |                                     8.3 |
| Wed 04/14 (lab)     | Lab 9: Trees                                 |                          Project 1 Due! |
| Fri 04/16           | Tree Traversals                              |                                     8.4 |
|---------------------+----------------------------------------------+-----------------------------------------|
| Mon 04/19 (Week 13) | Priority Queues                              |                                 9.1-9.3 |
| Wed 04/21           | Heapify, Sorting                             |                                     9.4 |
| Wed 04/21 (lab)     | Lab 10: Heaps and Heapsort                   |                                         |
| Fri 04/23           | Maps: Naive Implementations                  |                              10.1, 10.3 |
|---------------------+----------------------------------------------+-----------------------------------------|
| Mon 04/26 (Week 14) | Hash Tables and related                      |                              10.2, 10.5 |
| Wed 04/28           | Binary Search Trees                          |                               11.1-11.2 |
| Wed 04/28 (lab)     | Project 2                                    |                                         |
| Fri 04/30           | AVL Trees                                    |                                    11.3 |
|---------------------+----------------------------------------------+-----------------------------------------|
