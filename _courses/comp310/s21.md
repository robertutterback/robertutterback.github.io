...
| Fri 03/05                   | Entity-Relationship Model                  |                              6.1-6.7, 6.10, [Project 1](proj.pdf) |
|-----------------------------+--------------------------------------------+-------------------------------------------------------------------|
| Mon 03/08 (Week 7)          | Advanced Data Modeling                     |                                                    6.8, 6.9, 6.11 |
| Wed 03/10                   | Normalization                              |                                7.1-7.9, Project Enterprise chosen |
...
| Wed 03/24                   |                                            |                                                                   |
| Fri 03/26                   | Exam 2                                     | [Homework 4](hwk4/), Relational model checkpoint meeting deadline |
|-----------------------------+--------------------------------------------+-------------------------------------------------------------------|
