...
| Wed 02/03                   | Set Operations and NULL values             |                      3.4-3.6 |
| Fri 02/05                   | Aggregating, Grouping, and more            | [Homework 2](hwk2/), 3.7-3.8 |
|-----------------------------+--------------------------------------------+------------------------------|
| Mon 02/08 (Week 3)          | Database Modifications                     |                     3.9-3.10 |
| Wed 02/10                   |                                            |                              |
| Fri 02/12                   |                                            |          [Homework 3](hwk3/) |
|-----------------------------+--------------------------------------------+------------------------------|
