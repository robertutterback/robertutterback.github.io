...
| Wed 01/19                | Performance; Security                      | Read 1.4-1.8, PS 1             |
| Fri 01/21                | The Web and HTTP                           | Read 2.1-2.2, W1 Due           |
| ------                   | ------                                     | ------                         |
| Mon 01/24 (Week 3)       | SMTP, DNS, and Peer-to-Peer                | 2.3-2.5                        |
| Wed 01/26                | Streaming; Socket Programming              | 2.6-2.8                        |
| Fri 01/28                |                                            |                                |
| ------                   | ------                                     | ------                         |
| Mon 01/31 (Week 4)       |                                            |                                |
| Wed 02/02                | Exam 1                                     |                                |
