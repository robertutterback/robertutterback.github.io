...
| ------                | ------                                 | ------                                            |
| Mon 09/20 (Week 5)    | Floating Point                         | CSAPP 2.4                                         |
| Wed 09/22             | Machine Language: Basics               | CSAPP 3.1-3.5 (optional: DIS 6-7), [Hwk 2](./h2)  |
| Fri 09/24             | ML: Control                            | CSAPP 3.6                                         |
| ------                | ------                                 | ------                                            |
| Mon 09/27 (Week 6)    | ML: Procedures                         | CSAPP 3.7, [Prog 4](./p4) (Binary Bomb)           |
| Wed 09/29             | ML: Data                               | CSAPP 3.8-3.9                                     |
| Fri 10/01             | ML: Advanced                           | CSAPP 3.10, **Prog 3 Due**                        |
| ------                | ------                                 | ------                                            |
