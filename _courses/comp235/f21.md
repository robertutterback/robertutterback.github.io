...
| Fri 08/27             | Intro to C                           | DIS 1 and [this][1] (skim 9 & 10), [Prog 1](p1.pdf) |
| ------                | ------                               | ------                                              |
| Mon 08/30 (Week 2)    | C Exercises                          |                                                     |
| Wed 09/01             | Pointers                             | DIS 2.1-2.3                                         |
| Fri 09/03             | Dynamic Memory                       | DIS 2.4-2.8, [Hwk 1](h1.pdf)                        |
| ------                | ------                               | ------                                              |
...
| Fri 09/24             |                                      |                                                     |
| ------                | ------                               | ------                                              |
| Mon 09/27 (Week 6)    |                                      | [Prog 3](p4.pdf) (Binary Bomb)                      |
| Wed 09/29             |                                      |                                                     |
| Fri 10/01             |                                      |                                                     |
| ------                | ------                               | ------                                              |
