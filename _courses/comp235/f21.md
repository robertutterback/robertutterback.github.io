...
Since we will be using a lot of C, I recommend, but do not require,
some kind of reference manual. The following is pretty good:
...
* **Late Assignments**: {{ site.data.policies.late_days_v2 }}
...
| Fri 09/10             |                                      |                                    |
| ------                | ------                               | ------                             |
| Mon 09/13 (Week 4)    | Data Representation                  | CSAPP 2                            |
| Wed 09/15             |                                      | [Prog 2](p2.pdf) (Data)            |
| Fri 09/17             |                                      |                                    |
| ------                | ------                               | ------                             |
| Mon 09/20 (Week 5)    | Machine Language                     | CSAPP 3                            |
...
| Fri 10/01             |                                      |                                    |
| ------                | ------                               | ------                             |
| Mon 10/04 (Week 7)    | Code Optimization                    | CSAPP 5                            |
...
| ------                | ------                               | ------                             |
| Mon 10/18 (Week 9)    | Memory Hierarchy                     | CSAPP 6                            |
| Wed 10/20             |                                      |                                    |
