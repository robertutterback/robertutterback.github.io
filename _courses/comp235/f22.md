...
| Wed 11/16             | Memory Hierarchy II                         | Prog 5 (Cache Lab)                      |
| Fri 11/18             | Caches                                      | CSAPP 6.4-6.7                           |
|-----------------------+---------------------------------------------+-----------------------------------------|
| Mon 11/21 (Week 14)   | Performance Impact of Caches                | [Hwk 4](./h4), [Prog 5 (Cache Lab)][12] |
| (Wed 11/23)           | (Thanksgiving Break)                        |                                         |
| (Fri 11/25)           | (Thanksgiving Break)                        |                                         |
|-----------------------+---------------------------------------------+-----------------------------------------|
| Mon 11/28 (Week 15)   | Linking                                     | CSAPP 7                                 |
| Wed 11/30             |                                             | Hwk 6                                   |
| Fri 12/02             | Virtual Memory                              | CSAP 9, Prog 6 (Malloc)                 |
|-----------------------+---------------------------------------------+-----------------------------------------|
| Mon 12/05 (Week 16)   |                                             |                                         |
| Wed 12/07             | Exceptional Control Flow                    | CSAPP 8                                 |
| ======                | =======                                     | ======                                  |
