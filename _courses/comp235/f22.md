...
| Wed 11/09             | ML: Data                                    | 3.8,3.9,3.11*, [Hwk 3](./h3)              |
| Fri 11/11             | Buffer Overflows                            | 3.10                                      |
|-----------------------+---------------------------------------------+-------------------------------------------|
| Mon 11/14 (Week 13)   | Memory Hierarchy                            | CSAPP 6.1-6.3                             |
| Wed 11/16             | Caches                                      | CSAPP 6.4-6.7, Prog 5 (Cache Lab)         |
| Fri 11/18             | Linking                                     | CSAPP 7                                   |
|-----------------------+---------------------------------------------+-------------------------------------------|
