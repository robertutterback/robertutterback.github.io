...
|-----------------------+---------------------------------------------+------------------------------------|
| Mon 10/31 (Week 11)   | ML: Procedures                              | CSAPP 3.7                          |
| Wed 11/02             | ML: Data                                    | CSAPP 3.8-3.9                      | 
| Fri 11/04             | Structure Alignment                         | CSAPP 3.10, Hwk 4                  |
|-----------------------+---------------------------------------------+------------------------------------|
| Mon 11/07 (Week 12)   | Buffer Overflows                            |                                    |
| Wed 11/09             | Memory Hierarchy                            | CSAPP 6.1-6.3                      |
| Fri 11/11             | Caches                                      | CSAPP 6.4-6.7, Prog 5 (Cache Lab)  |
|-----------------------+---------------------------------------------+------------------------------------|
| Mon 11/14 (Week 13)   |                                             |                                    |
| Wed 11/16             | Linking                                     | CSAPP 7, Hwk 5                     |
| Fri 11/18             |                                             |                                    |
|-----------------------+---------------------------------------------+------------------------------------|
