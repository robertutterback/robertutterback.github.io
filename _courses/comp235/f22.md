...
| Fri 09/16             | Data Representation and Bit Operations | CSAPP 2.1                          |
|-----------------------+----------------------------------------+------------------------------------|
| Mon 09/19 (Week 5)    | Prog 2 Review; Integer Representations | CSAPP 2.2, Prog 3 (Data Lab)       |
| Wed 09/21             | Integer Arithmetic                     | CSAPP 2.3                          |
| Fri 09/23             | Exercises                              |                                    |
|-----------------------+----------------------------------------+------------------------------------|
| Mon 09/26 (Week 6)    | Floating Point I                       | CSAPP 2.4                          |
| Wed 09/28             | Hwk 2 Solutions, Floating Point II     |                                    |
| Fri 09/30             | Data Lab Questions                     |                                    |
|-----------------------+----------------------------------------+------------------------------------|
| Mon 10/03 (Week 7)    | ML: Basics I                           | CSAPP 3.1-3.4, Hwk 3               |
| Wed 10/05             | ML: Basics II                          | CSAPP 3.5                          |
| Fri 10/07             | ML: Control                            | CSAPP 3.6, Prog 4 (Bomb Lab)       |
|-----------------------+----------------------------------------+------------------------------------|
