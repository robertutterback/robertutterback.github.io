...
3. Though most assignments will use the interactive textbook, I may or
   may give some assignments/projects via
   [Replit](https://replit.com), an online development
   service. Students will receive, complete, and submit assignments
   all via the website. If/when Replit is used, you will receive
   instructions on how to create an account and join our course.
...
* **Late assignments**: {{ site.data.policies.late_days_v3 }}
...
| Fri 08/27             |                                       | FOPP 1: General Introduction               |
| ------                | ------                                | ------                                     |
| Mon 08/30 (Week 2)    |                                       | FOPP 2: Variables, Statements, Expressions |
| Wed 09/01             |                                       |                                            |
| Fri 09/03             |                                       | FOPP 3: Debugging                          |
| ------                | ------                                | ------                                     |
| Mon 09/06 (Week 3)    |                                       |                                            |
| Wed 09/08             |                                       | FOPP 4: Python Modules                     |
| Fri 09/10             |                                       | FOPP 5: Python Turtle                      |
| ------                | ------                                | ------                                     |
| Mon 09/13 (Week 4)    |                                       |                                            |
| Wed 09/15             |                                       | FOPP 6: Sequences                          |
| Fri 09/17             | Exam 1                                |                                            |
| ------                | ------                                | ------                                     |
| Mon 09/20 (Week 5)    |                                       | FOPP 7.1-7.7: Iteration                    |
| Wed 09/22             |                                       | FOPP 12: Functions                         |
| Fri 09/24             |                                       |                                            |
| ------                | ------                                | ------                                     |
| Mon 09/27 (Week 6)    |                                       | FOPP 8: Conditionals                       |
| Wed 09/29             |                                       |                                            |
| Fri 10/01             |                                       |                                            |
| ------                | ------                                | ------                                     |
...
| Wed 12/08             |                                       |                                            |
| ======                | =======                               | ======                                     |
| **Wed 12/15 8:00 AM** | **Exam 4 (Final)**                    |                                            |
