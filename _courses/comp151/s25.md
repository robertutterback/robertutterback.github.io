...
| :---                           | :---:                                               | --:                                             |
| Wed 01/22 (Week 1)             | Intro and Logistics                                 |                                                 |
...
| Fri 02/07                      | Sequences                                           | FOPP 6.1-6.5                                    |
|--------------------------------+-----------------------------------------------------+-------------------------------------------------|
| Mon 02/10 (Week 4)             | Exam 1 Review                                       |                                                 |
| **Mon 02/10 (lab)**            | Lab 03: Input-Compute-Output                        | (No Homework)                                   |
| Wed 02/12                      | Exam 1                                              |                                                 |
| Fri 02/14                      | Exam 1 Solutions                                    |                                                 |
|--------------------------------+-----------------------------------------------------+-------------------------------------------------|
| Mon 02/17 (Week 5)             | Sequence Methods                                    | 6.6-6.9                                         |
| **Mon 02/17 (lab)**            | Lab 04: Generating a Password                       | Homework 3 out                                  |
| Wed 02/19                      | More About For Loops                                | FOPP 7.1-7.7 <!-- R9 -->                        |
| Fri 02/21                      | Exercises: Sequences and For Loops                  |                                                 |
|--------------------------------+-----------------------------------------------------+-------------------------------------------------|
| Mon 02/24 (Week 6)             | Functions I                                         | 7.9,7.10,7.12 AND 12.1-12.5                     |
| **Mon 02/24 (lab)**            | Lab 05: Computing Statistics with Kiva Data         | Project 1 out                                   |
| Wed 02/26                      | Lab 05 Solutions/Review + Project Setup             |                                                 |
| Fri 02/28                      | Conditionals I                                      | FOPP 8.1-8.7 <!-- R11 -->                       |
|--------------------------------+-----------------------------------------------------+-------------------------------------------------|
| Mon 03/03 (Week 7)             | More Conditionals                                   | FOPP 8.8-8.11 <!-- R12 -->                      |
...
|--------------------------------+-----------------------------------------------------+-------------------------------------------------|
| Mon 03/17 (Week 8)             | Exam 2 Solutions                                    |                                                 |
...
| **Mon 03/24 (lab)**            | Lab 06: Local Python Development Setup              | Homework 4 out                                  |
| Wed 03/26                      | Project 1 Debrief                                   |                                                 |
| Fri 03/28                      | Transforming Sequences II                           | FOPP 9.8-9.14 <!-- R15 -->                      |
|--------------------------------+-----------------------------------------------------+-------------------------------------------------|
| Mon 03/31 (Week 10)            | <a id="current"></a>(no class)                      |                                                 |
| **Mon 03/31 (lab)**            | Lab 07: Substitution Ciphers                        | Homework 5 out                                  |
| Wed 04/02                      | Nested Iteration                                    | FOPP 7.8-7.12                                   |
| Fri 04/04                      | Guest Speaker: Israel Dereb                         |                                                 |
|--------------------------------+-----------------------------------------------------+-------------------------------------------------|
| Mon 04/07 (Week 11)            | Hwk 4 Presentations; More Iteration                 | FOPP 14 <!-- R17 -->                            |
| **Mon 04/07 (lab)**            | Lab 08: Image Processing                            | (No homework)                                   |
| Wed 04/09                      | Exam 3 Review                                       |                                                 |
| Fri 04/11                      | Exam 3                                              |                                                 |
|--------------------------------+-----------------------------------------------------+-------------------------------------------------|
| Mon 04/14 (Week 12)            | (No class)                                          | FOPP 11.1-11.4                                  |
| **Mon 04/14 (lab)**            | (No lab)                                            |                                                 |
| Wed 04/16                      | Dictionaries I                                      | FOPP 11.5-11.9                                  |
| (Fri 04/18)                    | (Easter Break)                                      |                                                 |
|--------------------------------+-----------------------------------------------------+-------------------------------------------------|
| (Mon 04/21) (Week 13)          | (Easter Break)                                      |                                                 |
| Wed 04/23                      | Project 2, Dictionaries II                          | Project 2 out                                   |
| Fri 04/25                      | Files                                               | FOPP 10                                         |
|--------------------------------+-----------------------------------------------------+-------------------------------------------------|
| Mon 04/28 (Week 14)            | Testing, Exceptions                                 | FOPP 18-19                                      |
| **Mon 04/28 (lab)**            | (Reserved for Project 2)                            |                                                 |
| Wed 04/30                      | Lab Review: Ciphers                                 |                                                 |
| Fri 05/02                      | Guided Lab: Roman Numerals                          |                                                 |
|--------------------------------+-----------------------------------------------------+-------------------------------------------------|
| Mon 05/05 (Week 15)            | Guided Lab: Predicting Pizza Prices with Regression |                                                 |
| **Mon 05/05 (lab)**            | (Reserved for Project 2)                            |                                                 |
| Wed 05/07                      | Exam Review                                         | Project 2 due @midnight                         |
| ======                         | ======                                              | ========                                        |
