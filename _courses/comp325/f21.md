...
| ------                | ------                               | ------                                                                                            |
| Mon 10/11 (Week 8)    | Prog3 Solutions/Review               | [Interp 2B](./prog3b.pdf) (Due 10/20; optional) ([Starter code][1])                               |
| (Wed 10/13)           | (Exam day for half-semester courses) |                                                                                                   |
| (Fri 10/15)           | (Fall Break)                         |                                                                                                   |
| ------                | ------                               | ------                                                                                            |
| Mon 10/18 (Week 9)    | Prog3 Solutions/Review               | [Hwk5](./hwk5), [Interp 3](./prog4.pdf)                                                           |
| Wed 10/20             | Type Inference                       | PAPL 31                                                                                           |
| Fri 10/22             | Sharing and Equality                 | PAPL 20                                                                                           |
| ------                | ------                               | ------                                                                                            |
| Mon 10/25 (Week 10)   | State                                | PAPL 22                                                                                           |
| Wed 10/27             | Mutation                             | PAPL 32                                                                                           |
| Fri 10/29             |                                      | (Prog4 Due Saturday)                                                                              |
| ------                | ------                               | ------                                                                                            |
...
[1]: https://code.pyret.org/editor#share=1NL_lw7I7VGfPPKHHyZBfNcDi-duU1Cb1&v=1904b2c
