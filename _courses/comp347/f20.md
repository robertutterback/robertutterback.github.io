...
|---------------------+----------------------------------------------------+------------------------------------------------------------------------------|
| Mon 09/21 (Week 6)  | Categorical Features, Missing Values               | IMLP 4, [Hwk 3](hwk3.ipynb) out ([Leaderboard](hwk3-leaderboard/index.html)) |
| Wed 09/23           | Hwk 2 Discussion More Preprocessing                |                                                                              |
| Fri 09/25           | Support Vector Machines                            | IMLP p. 94 -- 106                                                            |
|---------------------+----------------------------------------------------+------------------------------------------------------------------------------|
| Mon 09/28 (Week 7)  | Classification Evaluation                          | IMLP 5.3                                                                     |
| Wed 09/30           | Decision Trees                                     | IMLP p. 72 -- 85                                                             |
| Fri 10/02           |                                                    |                                                                              |
|---------------------+----------------------------------------------------+------------------------------------------------------------------------------|
