...
| Wed 10/28           | Clustering                                         | IMLP 3.1, 3.2, 3.5, [Hwk 4](hwk4.ipynb) out                                  |
...
|---------------------+----------------------------------------------------+------------------------------------------------------------------------------|
| Mon 11/09 (Week 13) | Neural Networks                                    | IMLP p. 106 -- 121, [Watch 3blue1brown][4]                                   |
| Wed 11/11           | Neural Networks in Practice                        | [Hwk 5](hwk5.pdf) out                                                         |
| Fri 11/13           | Convolutional Neural Networks                      |                                                                              |
|---------------------+----------------------------------------------------+------------------------------------------------------------------------------|
| Mon 11/16 (Week 14) | Keras and Tensorflow                               |                                                                              |
