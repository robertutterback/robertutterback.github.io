...
| Wed 10/21           | Model Interpretation and Feature Selection         |                                                                              |
| Fri 10/23           | Dimensionality Reduction                           | IMLP 3.4                                                                     |
|---------------------+----------------------------------------------------+------------------------------------------------------------------------------|
| Mon 10/26 (Week 11) | Clustering                                         | IMLP 3.1, 3.2, 3.5                                                           |
| Wed 10/28           | Text Vectorization and Normalization               | IMLP 7, Hwk 4 out                                                            |
| Fri 10/30           | Topic Modeling                                     |                                                                              |
|---------------------+----------------------------------------------------+------------------------------------------------------------------------------|
