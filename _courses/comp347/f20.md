...
|---------------------+-----------------------------------------------------------+------------------------------------------------------------------------------|
| Mon 09/21 (Week 6)  | Categorical Features, Missing Values, Feature Engineering | IMLP 4, [Hwk 3](hwk3.ipynb) out ([Leaderboard](hwk3-leaderboard/index.html)) |
| Wed 09/23           | Support Vector Machines                                   | IMLP p. 94 -- 106                                                            |
