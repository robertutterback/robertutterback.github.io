...
|-----------------------+------------------------------------------+------------------------------------------------|
| Mon 08/29 (Week 2)    | NumPy                                    | [NumPy Tutorial][1], [Hwk 1](hwk1.ipynb)       |
| Wed 08/31             | Pandas                                   | [Pandas Tutorials][2] (all except time series) |
| Fri 09/02             | Python Visualization Basics              | [Matplotlib Basic Usage][3]                    |
|-----------------------+------------------------------------------+------------------------------------------------|
| Mon 09/05 (Week 3)    | Case Studies                             | p. 35--61                                      |
| Wed 09/07             | Model Selection & Validation             | p. 62--83                                      |
| Fri 09/09             | Preprocessing                            |                                                |
|-----------------------+------------------------------------------+------------------------------------------------|
| Mon 09/12 (Week 4)    | Classification & Model Evaluation        | p. 85--100                                     |
| Wed 09/14             |                                          | p. 100--109                                    |
| Fri 09/16             | Calibration & Imbalanced Data            |                                                |
|-----------------------+------------------------------------------+------------------------------------------------|
| Mon 09/19 (Week 5)    | Training Models                          | p. 111--130                                    |
| Wed 09/21             | Feature Engineering                      |                                                |
| Fri 09/23             | Complexity & Regularization              | p. 130--142                                    |
|-----------------------+------------------------------------------+------------------------------------------------|
| Mon 09/26 (Week 6)    |                                          |                                                |
| Wed 09/28             | Logistic Regression                      | p. 142--151                                    |
| Fri 09/30             |                                          |                                                |
|-----------------------+------------------------------------------+------------------------------------------------|
| Mon 10/03 (Week 7)    | Support Vector Machines                  | p. 153--164                                    |
| Wed 10/05             | SVM Details                              | p. 164--174                                    |
| Fri 10/07             | Model Interpretation & Feature Selection |                                                |
|-----------------------+------------------------------------------+------------------------------------------------|
