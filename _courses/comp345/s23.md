...
|--------------------------+----------------------------------------------+-------------------------------------|
| Mon 02/13 (Week 6)       | Multi-level Page Tables                      | [20][20]                            |
| Wed 02/15                | Swapping, Replacement Policies               | [21][21],[22][22]                   |
| Fri 02/17                | Exam Review                                  |                                     |
|--------------------------+----------------------------------------------+-------------------------------------|
| Mon 02/20 (Week 7)       | Exam 1                                       |                                     |
| Wed 02/22                | Exam Solutions                               |                                     |
| Fri 02/24                | Intro to Concurrency                         | [25][25],[26][26]                   |
|--------------------------+----------------------------------------------+-------------------------------------|
| Mon 02/27 (Week 8)       | Thread API                                   | [27][27]                            |
| Wed 03/01                | Locks                                        | [28][28]                            |
| (Fri 03/03)              | (Exam day for 1st half-semester courses)     |                                     |
|--------------------------+----------------------------------------------+-------------------------------------|
| (Mon 03/06 -- Fri 03/10) | (Spring Break)                               |                                     |
|--------------------------+----------------------------------------------+-------------------------------------|
| Mon 03/13 (Week 9)       | Concurrent Data Structures                   | [29][29]                            |
| Wed 03/15                | Condition Variables                          | [30][30]                            |
| Fri 03/17                | Semaphores                                   | [31][31]                            |
|--------------------------+----------------------------------------------+-------------------------------------|
